...
/* harmony import */ var _phones_phones_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);


// eslint-disable-next-line no-unused-vars
const currentPage = new _phones_phones_page__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/* harmony import */ var _components_phone_catalog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _components_phone_viewer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _components_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var _components_shopping_cart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _services_phone_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
...
class PhonesPage {
  ...
  _initCatalog() {
    this._catalog = new _components_phone_catalog__WEBPACK_IMPORTED_MODULE_0__["default"]({
      element: document.querySelector('[data-component="phone-catalog"]'),
      phones: _services_phone_service__WEBPACK_IMPORTED_MODULE_4__["default"].getAll(),
    });
    this._catalog.subscribe('phone-selected', (phoneId) => {
      const phoneDetails = _services_phone_service__WEBPACK_IMPORTED_MODULE_4__["default"].getById(phoneId);
      this._catalog.hide();
  ...
  _initViewer() {
    this._viewer = new _components_phone_viewer__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  _initShoppingCart() {
    this._cart = new _components_shopping_cart__WEBPACK_IMPORTED_MODULE_3__["default"]({
      element: document.querySelector('[data-component="shopping-cart"]'),
    });
  }

  _initFilter() {
    this._filter = new _components_filter__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
class PhoneCatalog extends _component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({
    element,
    phones = [],
  }) {
...
class PhoneViewer extends _component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({ element }) {
    super({ element });
...
class ShoppingCart extends _component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({ element }) {
    super({ element });
